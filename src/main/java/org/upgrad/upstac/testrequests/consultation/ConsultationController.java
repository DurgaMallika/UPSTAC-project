...
public class ConsultationController {
  ...
  // This method will return all the requests with the status LAB_TEST_COMPLETED
  ...
  @GetMapping
  @PreAuthorize("hasAnyRole('DOCTOR')")
  // This method will return all the requests assigned for the current logged in doctor
  ...
  // This method will assign the selected test request to the current logged in doctor
  ...
  // This method will update the result of selected test request with the consulted doctor comments
